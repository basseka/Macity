-- Cron job : scrape les actualités + agenda de la mairie de Balma chaque jour à 7h15 UTC (9h15 CET)
SELECT cron.schedule(
  'scrape-mairie-balma-daily',
  '15 7 * * *',
  $$
  SELECT net.http_post(
    url    := 'https://dpqxefmwjfvoysacwgef.supabase.co/functions/v1/scrape-mairie-balma',
