...
class FarmVenueCard extends ConsumerWidget {
  final FarmVenue venue;

  const FarmVenueCard({super.key, required this.venue});
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: const Text('\u{1F404}', style: TextStyle(fontSize: 24)),
                ),
              ),
              Expanded(
                child: Padding(
      ...
      ItemDetailSheet(
        ...
        secondaryActions: [
          ...
          if (venue.lienMaps.isNotEmpty)
            DetailAction(icon: Icons.map_outlined, label: 'Itineraire', url: venue.lienMaps),
        ],
