...
class LaserGameVenueCard extends ConsumerWidget {
  final LaserGameVenue venue;

  const LaserGameVenueCard({super.key, required this.venue});
          ...
          children: [
            SizedBox(
              ...
              child: Container(
                ...
                child: const Text('\u{1F52B}', style: TextStyle(fontSize: 30)),
              ),
            ),
            Expanded(
              child: Padding(
