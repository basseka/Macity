...
void main() {
  runZonedGuarded(
    () async {
      ...
      // Edge-to-edge requis sur Android 15+ (targetSdk 35).
      // Le contenu se dessine sous les system bars ; Scaffold/SafeArea/MediaQuery
      // gerent les insets automatiquement.
